...
<body>
    ...
    <main>
        <div class="container">
            <div class="checkGiveConte">
                <h3 class="loginTitle">金額確認</h3>
                <h2 class="CheckGiveH2"><?php echo $yen ;?>円</h2>
                <p class="CheckGiveP">上記のご支援金額で間違いはありませんか？</p>
                <form action="./giveFun.php" method="get">
                    <input type="hidden" name="money" value="<?php echo $yen;?>">
                    <input type="hidden" name="id" value="<?php echo $id;?>">
                    <input class="button" type="submit" value="確定する">
                </form>
            </div>
